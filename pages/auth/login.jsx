                ...
                <div className="w-full max-w-md bg-slate-800/50 backdrop-blur-xl rounded-2xl p-8 shadow-xl border border-slate-700 relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <button
                                className="w-full px-8 py-3.5 rounded-full relative bg-gradient-to-r from-teal-500 to-blue-500 text-white font-medium hover:shadow-2xl hover:shadow-teal-500/10 transition duration-200 border-0 disabled:opacity-50 disabled:cursor-not-allowed group"
                                type="submit"
                                disabled={loading}
                            >
